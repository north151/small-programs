...
void died_1()
{
	...
	for (i = 0; i < 30; i++)
	{
		if(bullet[0][i].isused==1)
			...
			{
				IMAGE bank1;
				loadimage(&bank1, _T("D:\\坦克动荡素材\\坦克3.jpg"), playerpicwidth, playerpichigh);
...
void died_2()
{
	...
	for (i = 0; i < 30; i++)
	{
		if(bullet[0][i].isused==1)
			...
			{
				IMAGE bank2;
				loadimage(&bank2, _T("?D:\\坦克动荡素材\\坦克3.jpg"), playerpicwidth, playerpichigh);
